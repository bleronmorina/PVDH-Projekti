...
# Load the datasets
hdi_data = pd.read_csv('../../Processed DataSet/Phase I/HDI Data v1.csv')
world_bank_data = pd.read_csv('../../Processed DataSet/Phase I/WorldBank v1.csv')
...
merged_data.to_csv('../../Processed DataSet/Phase I/Merged_HDI_WorldBank_Data v2.csv', index=False)
